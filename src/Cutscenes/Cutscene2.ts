...
export default class Cutscene2 extends Phaser.Scene {
    private slides = [
        {
            ...
            text: "WARNING: Multiple viral particles have entered the cellular environment. They are moving quickly through the infected area."
        },
        {
            imagePath: '/assets/Cutscenes/Cutscene2_4.png',
            text: "The infection is spreading. Viral particles are attempting to breach deeper into the cell and disrupt its internal systems."
        },
        {
            imagePath: '/assets/Cutscenes/Cutscene2_3.png',
            text: "Some particles are becoming more aggressive and harder to stop. You must identify the threats before too many of them escape."
        },
        {
            imagePath: '/assets/Cutscenes/Cutscene2_2.png',
            text: "Your mission is to aim with the defense crosshair and shoot the viruses before they can pass through the cell membrane."
        }
    ];
    ...
    preload() {
        // Non carichiamo più l'immagine delle frecce,
        // perché in questo minigioco si mira con mouse/touchpad.
    }
