...
export default class Cutscene3 extends Phaser.Scene {
    ...
    create() {
        ...
        this.slides[0].text = allDialogues.cutscenes.cutscene_3.dialogue_1;
        this.slides[1].text = allDialogues.cutscenes.cutscene_3.dialogue_2;
        this.slides[2].text = allDialogues.cutscenes.cutscene_3.dialogue_3;
        this.slides[3].text = allDialogues.cutscenes.cutscene_3.dialogue_4;
    ...
    private drawControlsUI(width: number, height: number) {
        ...
        this.controlsPrompt = this.add
            .text(
                width / 2,
                height - 150 * uiScale,
                'Press SPACE or PINCH to start the mission',
                {
                    fontSize: '26px',
                    color: '#4caf50',
                    fontStyle: 'bold'
