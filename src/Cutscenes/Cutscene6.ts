...
export default class Cutscene6 extends Phaser.Scene {
    private slides = [
        {
            imagePath: '/assets/Cutscenes/Cutscene6_1.png',
            text: ''
        },
        {
            imagePath: '/assets/Cutscenes/Cutscene6_2.png',
            text: ''
        },
        {
            imagePath: '/assets/Cutscenes/Cutscene6_3.png',
            text: ''
        },
        {
            imagePath: '/assets/Cutscenes/Cutscene6_4.png',
            text: ''
        }
    ];
    ...
    create() {
        ...
        this.slides[0].text = allDialogues.cutscenes.cutscene_6.dialogue_1;
        this.slides[1].text = allDialogues.cutscenes.cutscene_6.dialogue_2;
        this.slides[2].text = allDialogues.cutscenes.cutscene_6.dialogue_3;
        this.slides[3].text = allDialogues.cutscenes.cutscene_6.dialogue_4;
