...
const config: Phaser.Types.Core.GameConfig = {
    ...
    scene: [TitleScene, OptionsScene, MenuPageScene, HandCursorScene, Level1, Level2, Level3, Level4, Level5, Level6, FinalBoss, ExternalScene, Scene2_Membrane, Scene3_Internal, PauseMenuScene, ControlsScene] 
};
